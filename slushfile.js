...
gulp.task('scraper', ['clear'], function()
{
    ...
    .pipe(cheerio(function ($, file)
    {
        ...
        try
        {
            cache_file = jsonfile.readFileSync('cache/unorganized_things.json');
        ...
        catch (e)
        {
            ...
            jsonfile.writeFileSync('cache/unorganized_things.json', schema.unorganized_things, {spaces: 2});
            gutil.log( gutil.colors.green('Unorganized things now cached! previous processes will not need to repeat next time') );
        }
        ...
        try
        {
            cache_file = jsonfile.readFileSync('cache/organized_things.json');
        ...
        catch (e)
        {
            ...
            jsonfile.writeFileSync('cache/organized_things.json', schema.organized_things, {spaces: 2});
            gutil.log( gutil.colors.green('Organized things now cached! previous processes will not need to repeat next time') );
        }
